...
const Philosophy = () => {
  return (
    <div className="w-screen h-auto py-36 bg-[url('/images/sea-black.png')] bg-cover">
      <div className="w-10/12 mx-auto ">
        <h1 className="section-title text-white">Philosophy</h1>
        <p className="block text-white text-base font-mono font-medium leading-relaxed">
          ⾃分の本当の思いや欲望、隠しておきたい気持ちなど、
          <br />
          ⾃分しか知らない⾃分だけの深遠な秘境。
          <br />
